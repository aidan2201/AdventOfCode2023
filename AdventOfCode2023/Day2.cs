...
namespace AdventOfCode2023
{
    public static class Day2
    {
        ...
        public static int Puzzle1Solution()
        {
            ...
            {
                var stringWithoutGameNumber = game.Remove(0, 6 + count.ToString().ToCharArray().Count()); // 4 for Game, 1 for space, count.tostring.tochararray.count amount, 1 for space
        ...
        private static bool IsGameValid(List<string> colourInfo)
        {
            var result = true;
